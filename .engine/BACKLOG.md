...
- `#15 · Multi-display + Spaces awareness · S0` [DEP: shape — needs #10's engine surface]
- `#16 · Sparkle auto-updates + release pipeline · S0` [DEP: blocked-by #13]
- `#17 · Gap/padding settings UI + per-app profiles · S0` [DEP: shape — post-MVP polish]
